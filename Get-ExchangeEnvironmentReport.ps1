	...
	foreach ($Server in $Servers.Value)
	{
		...
		if ($Server.RealName -ne $Server.Name)
		{
			$Output+=" ($($Server.RealName))"
				...
				### Added by Jeff Guillet
		$IpAddresses = $null
		Get-WMIObject -Computername $Server.Name win32_NetworkAdapterConfiguration -ErrorAction SilentlyContinue |
		   Where-Object { $_.IPEnabled -eq $true } |
		   Foreach-Object { $_.IPAddress } |
		   Foreach-Object { [IPAddress]$_ } |
		   Where-Object { $_.AddressFamily -eq 'Internetwork'  } |
		   Foreach-Object { $IpAddresses += $_.IPAddressToString + " " }
		$Output+=" [$($IpAddresses.trim())]"
...
Write-Progress "Get-ExchangeEnvironmentReport" -Completed
Write-Progress "Finishing off.." -Completed

# SIG # Begin signature block
# MIINHAYJKoZIhvcNAQcCoIINDTCCDQkCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU2oH7MG93BgbP5MhGrzSXmLDI
# HuegggpeMIIFJjCCBA6gAwIBAgIQDabkR8675p80ZdtFokcNRTANBgkqhkiG9w0B
...
# AQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTgf5eR3phn
# zK68qjHPuoy8VL2z1DANBgkqhkiG9w0BAQEFAASCAQBYlBezR77uIQVYBSUk+9pM
# us26XCqfe+UJcGXHtUG1WMoSrn7y3ZMOdyVyI2edF5RbQ23GCupYNxIR7egVsgM2
# H7cK8zanKW+s0+ImMKkyl4lIk8d56o6W3lDedHJ6v8ACvGoSb8MRQ4RcRxHptGfM
# OdHwFEJQfT2yQuin4O7k02+bz+WPPSiCayFLF6Jftva1paj6dpOt/qxPtQM1pn2l
# Vwp5/SzNPcTnfk7dx5OxvoE5IEucINK9Fw0qzBiozRzn4OMMPtVYv8G1KWXIQ4y4
# AN8IIvo15o5QLt717wX6gq/TFDVsHUNfn0LkVoQ6XYLA6rSIUJK/BIh+5jx3F4zm
